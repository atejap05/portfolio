...
export default function Home() {
  return (
    <div className="max-w-screen-xl min-h-screen py-2 px-4 m-auto">
      <section
        id="greetings"
        className="bg-gradient-to-t from-my-dark to-my-black shadow-md flex justify-between gap-2 px-8 pb-24 clip-path-mypolygon_b"
      >
        <div className="">
          <div className="mt-8">
            <Nav />
      ...
      <Element name="about" className="element">
        <section
          id="about"
          className="bg-gradient-to-b from-my-dark to-my-black shadow-md px-8 py-24 clip-path-mypolygon_y"
        >
          <p className="mb-6 uppercase text-md text-my-lighten">
            About my work
          </p>
          <h1
            className={`${crimsonPro.className} text-3xl sm:text-5xl leading-snug mb-10`}
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-16">
            <div>
              ...
              <p className="mb-6 leading-relaxed text-xl">
                ...
                using technologies such as HTML, CSS & JavaScript (ES6),
            ...
            <div>
              ...
              <p className="mb-6 leading-relaxed text-xl">
                ...
                using technologies such as Python, NodeJs, ExpressJs,
                PostgreSQL, MongoDB, Prisma, among others.
              </p>
              <div className="w-2/3">
                <BackendSkillList />
              </div>
